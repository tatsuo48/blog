                                ...
                                <Fragment>
                                    ...
                                    {social.twitter && (
                                        ...
                                        >
                                            <span className="fa-stack">
                                                <i className="fas fa-circle fa-stack-2x" />
                                                <i className="fab fa-twitter fa-stack-1x fa-inverse fa-lg" />
                                            </span>
                                        </a>
                                    )}
                                    {social.facebook && (
                                        ...
                                        >
                                            <span className="fa-stack">
                                                <i className="fas fa-circle fa-stack-2x" />
                                                <i className="fab fa-facebook-f fa-stack-1x fa-inverse fa-lg" />
                                            </span>
                                        </a>
                                    )}
                                    {social.github && (
...
const bioQuery = graphql`
    query {
        avatar: file(absolutePath: { regex: "/my_pic.jpg/" }) {
            childImageSharp {
